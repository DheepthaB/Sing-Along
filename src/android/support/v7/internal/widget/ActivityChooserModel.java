  ...
  extends DataSetObservable
{
    ...
    extends AsyncTask<Object, Void, Void>
  {
    ...
    public Void doInBackground(Object... paramVarArgs)
    {
      ...
      //   0	476	0	this	PersistHistoryAsyncTask
      //   0	476	1	paramVarArgs	Object[]
      //   6	80	2	localList	List
      //   13	187	3	str	String
      //   182	25	4	localFileNotFoundException	FileNotFoundException
      //   26	433	6	localFileOutputStream	java.io.FileOutputStream
      //   31	195	7	localXmlSerializer	org.xmlpull.v1.XmlSerializer
      //   442	22	8	localObject	Object
      //   471	1	10	localIOException1	IOException
      //   379	31	11	localIOException2	IOException
      //   437	1	14	localIOException3	IOException
      //   316	31	15	localIllegalStateException	IllegalStateException
      //   374	1	18	localIOException4	IOException
      //   253	31	19	localIllegalArgumentException	java.lang.IllegalArgumentException
      //   311	1	22	localIOException5	IOException
      //   73	10	24	i	int
      //   76	101	25	j	int
      //   95	57	26	localHistoricalRecord	ActivityChooserModel.HistoricalRecord
      //   466	1	34	localIOException6	IOException
      // Exception table:
      //   from	to	target	type
