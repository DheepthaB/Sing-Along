...
public final class TintManager
{
  ...
  static
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      arrayOfInt5[4] = R.drawable.abc_btn_check_material;
      arrayOfInt5[5] = R.drawable.abc_btn_radio_material;
      arrayOfInt5[6] = R.drawable.abc_spinner_textfield_background_material;
      arrayOfInt5[7] = R.drawable.abc_ratingbar_full_material;
      arrayOfInt5[8] = R.drawable.abc_switch_track_mtrl_alpha;
      arrayOfInt5[9] = R.drawable.abc_switch_thumb_material;
      arrayOfInt5[10] = R.drawable.abc_btn_default_mtrl_shape;
      arrayOfInt5[11] = R.drawable.abc_btn_borderless_material;
