  ...
  implements MenuBuilder.Callback, LayoutInflaterFactory
{
  ...
  public View createView(View paramView, String paramString, @NonNull Context paramContext, @NonNull AttributeSet paramAttributeSet)
  {
    ...
    if (Build.VERSION.SDK_INT < 21)
    {
      ...
      if ((!bool1) || (!this.mSubDecorInstalled) || (paramView == null) || (paramView.getId() == 16908290)) {
        break label85;
      }
    }
    label85:
    ...
    {
      return this.mAppCompatViewInflater.createView(paramView, paramString, paramContext, paramAttributeSet, bool2, bool1);
      bool1 = false;
      break;
    }
  }
