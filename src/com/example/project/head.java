  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099747));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Head, Shoulders,Knees And Toes");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          head.this.progressDialog.dismiss();
          head.this.myVideoView.seekTo(head.this.position);
          if (head.this.position == 0)
          {
            head.this.myVideoView.start();
            return;
          }
          head.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.head
