  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099763));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("1 2 Buckle My Shoe");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          shoe.this.progressDialog.dismiss();
          shoe.this.myVideoView.seekTo(shoe.this.position);
          if (shoe.this.position == 0)
          {
            shoe.this.myVideoView.start();
            return;
          }
          shoe.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.shoe
