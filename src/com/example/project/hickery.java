  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099748));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Hickery Dickery Dock");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          hickery.this.progressDialog.dismiss();
          hickery.this.myVideoView.seekTo(hickery.this.position);
          if (hickery.this.position == 0)
          {
            hickery.this.myVideoView.start();
            return;
          }
          hickery.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.hickery
