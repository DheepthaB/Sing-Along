  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099749));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Hush Little Baby");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          hush.this.progressDialog.dismiss();
          hush.this.myVideoView.seekTo(hush.this.position);
          if (hush.this.position == 0)
          {
            hush.this.myVideoView.start();
            return;
          }
          hush.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.hush
