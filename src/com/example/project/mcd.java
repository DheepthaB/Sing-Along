  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099753));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Old MacDonald Had A Farm");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          mcd.this.progressDialog.dismiss();
          mcd.this.myVideoView.seekTo(mcd.this.position);
          if (mcd.this.position == 0)
          {
            mcd.this.myVideoView.start();
            return;
          }
          mcd.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.mcd
