  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099754));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Little Miss Muffet");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          muffet.this.progressDialog.dismiss();
          muffet.this.myVideoView.seekTo(muffet.this.position);
          if (muffet.this.position == 0)
          {
            muffet.this.myVideoView.start();
            return;
          }
          muffet.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.muffet
