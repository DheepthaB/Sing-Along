  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099741));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Chubby Cheeks");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          cheeks.this.progressDialog.dismiss();
          cheeks.this.myVideoView.seekTo(cheeks.this.position);
          if (cheeks.this.position == 0)
          {
            cheeks.this.myVideoView.start();
            return;
          }
          cheeks.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.cheeks
