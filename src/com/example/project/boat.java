  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099736));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("RowRow Row Your Boat");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          boat.this.progressDialog.dismiss();
          boat.this.myVideoView.seekTo(boat.this.position);
          if (boat.this.position == 0)
          {
            boat.this.myVideoView.start();
            return;
          }
          boat.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.boat
