  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099757));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Miss POly Had A Dolly");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          polly.this.progressDialog.dismiss();
          polly.this.myVideoView.seekTo(polly.this.position);
          if (polly.this.position == 0)
          {
            polly.this.myVideoView.start();
            return;
          }
          polly.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.polly
