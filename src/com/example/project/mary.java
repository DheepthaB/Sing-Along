  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099752));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Mary Mary Quite Contrary");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          mary.this.progressDialog.dismiss();
          mary.this.myVideoView.seekTo(mary.this.position);
          if (mary.this.position == 0)
          {
            mary.this.myVideoView.start();
            return;
          }
          mary.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.mary
