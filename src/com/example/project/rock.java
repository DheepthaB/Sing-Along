  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099760));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("ROck-A-Bye Baby");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          rock.this.progressDialog.dismiss();
          rock.this.myVideoView.seekTo(rock.this.position);
          if (rock.this.position == 0)
          {
            rock.this.myVideoView.start();
            return;
          }
          rock.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.rock
