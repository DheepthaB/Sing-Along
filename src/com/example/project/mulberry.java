  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099755));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("The Mulberry Bush");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          mulberry.this.progressDialog.dismiss();
          mulberry.this.myVideoView.seekTo(mulberry.this.position);
          if (mulberry.this.position == 0)
          {
            mulberry.this.myVideoView.start();
            return;
          }
          mulberry.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.mulberry
