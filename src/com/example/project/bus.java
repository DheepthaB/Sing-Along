  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.progressDialog.setTitle("Wheels On The Bus");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        public void onPrepared(MediaPlayer paramAnonymousMediaPlayer)
        {
          ...
          bus.this.myVideoView.seekTo(bus.this.position);
          if (bus.this.position == 0)
          {
            bus.this.myVideoView.start();
            return;
          }
          bus.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.bus
