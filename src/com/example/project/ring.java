  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099759));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Ring A Ring O'Roses");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          ring.this.progressDialog.dismiss();
          ring.this.myVideoView.seekTo(ring.this.position);
          if (ring.this.position == 0)
          {
            ring.this.myVideoView.start();
            return;
          }
          ring.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.ring
