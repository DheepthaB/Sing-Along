  ...
  extends Activity
{
  ...
  private Runnable UpdateSongTime = new Runnable()
  {
    public void run()
    {
      monkey.this.startTime = monkey.this.mediaPlayer.getCurrentPosition();
      TextView localTextView = monkey.this.startTimeField;
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = Long.valueOf(TimeUnit.MILLISECONDS.toMinutes(monkey.this.startTime));
      arrayOfObject[1] = Long.valueOf(TimeUnit.MILLISECONDS.toSeconds(monkey.this.startTime) - TimeUnit.MINUTES.toSeconds(TimeUnit.MILLISECONDS.toMinutes(monkey.this.startTime)));
      localTextView.setText(String.format("%d min, %d sec", arrayOfObject));
      monkey.this.seekbar.setProgress((int)monkey.this.startTime);
      monkey.this.myHandler.postDelayed(this, 100L);
    }
  };
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.songName.setText("5 Little Monkeys.mp3");
    this.mediaPlayer = MediaPlayer.create(this, 2131034113);
 ...
 * Qualified Name:     com.example.project.monkey
