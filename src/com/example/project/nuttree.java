  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099756));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("I Had A Little Nut Tree");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          nuttree.this.progressDialog.dismiss();
          nuttree.this.myVideoView.seekTo(nuttree.this.position);
          if (nuttree.this.position == 0)
          {
            nuttree.this.myVideoView.start();
            return;
          }
          nuttree.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.nuttree
