  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    this.myVideoView = ((VideoView)findViewById(2131099761));
    this.progressDialog = new ProgressDialog(this);
    this.progressDialog.setTitle("Roses Are Red");
    ...
    try
    {
      ...
      this.myVideoView.setOnPreparedListener(new MediaPlayer.OnPreparedListener()
      {
        ...
        {
          roses.this.progressDialog.dismiss();
          roses.this.myVideoView.seekTo(roses.this.position);
          if (roses.this.position == 0)
          {
            roses.this.myVideoView.start();
            return;
          }
          roses.this.myVideoView.pause();
        }
      });
      return;
    }
 ...
 * Qualified Name:     com.example.project.roses
